Feature: E2E testing of Insider "Apply for Job" Process
  ...
  Scenario: Verification of possibility to apply for a job through Insider
    ...
    Then I check all the Job List items "location" contains "Istanbul, Turkey" in Career Opportunities on Insider Career page
    Then I check all the Job List items "team" contains "Quality Assurance" in Career Opportunities on Insider Career page
